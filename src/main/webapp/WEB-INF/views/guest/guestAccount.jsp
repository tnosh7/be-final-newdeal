        ...
        <div class="container-kti">
            <div id="screen1">
                ...
                <div>
                    <div>
                        <div>
                            <section><h2 tabindex="-1" elementtiming="LCP-target">실명</h2></section>
                        </div>
                        <div id="legalName-row-subtitle">
                            <span>userName</span>
                        </div>
                    </div>
                    <div>
            ...
            <div id="screen2" style="border: 1px solid lightgray">
                <div id="bottom-kti">
                    <!-- 안내 문서 내용 -->
                    ...
                    <div>여기에 내 개인정보가 표시되지 않는 이유가 무엇인가요?</div>
